...
public class AccountController {
    ...
    public Mono createBankAccountPersonalType(@RequestBody AccountProduct account) {
        return accountproductService.createBankAccountPersonalType(account);
    }
    /**
    ...
    public Mono withdraw(String accountId, double amount) {
        return accountproductService.withdraw(accountId,amount);
    }
    /**
     * Method that update a Document by specific rule
     */
    ...
    public Mono deposit(String accountId, double amount) {
        return accountproductService.deposit(accountId,amount);
    }
    /**
     * Method that return one Document by ID
     */
    ...
    public Mono<Double> getAccountBalance(@PathVariable String id) {
        return accountproductService.getBalance(id);
    }
    /**
